...
@pytest.fixture
def model(base_model, tokenizer) -> MultilingualLanguageModel:
...
def test_japanese_generation(model: MultilingualLanguageModel, tokenizer) -> None:
    # 日本語のプロンプトを使用
...
def test_language_switching(model: MultilingualLanguageModel, tokenizer) -> None:
    # 日本語生成
...
def test_mask_strength_effect(model: MultilingualLanguageModel, tokenizer) -> None:
